 ...
 * @author hyuchiha
 */
public class TransaccionBancaria implements Runnable {
    ...
    public void run() {
        for (int i = 0; i <= 3; i++) {
            try {
                ...
                Logger.getLogger(TransaccionBancaria.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
